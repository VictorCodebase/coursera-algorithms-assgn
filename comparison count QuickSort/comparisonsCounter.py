...
Find the number of comparisons made by QuickSort
Shout out to Serhii Dymenko
view his linkedin: https://www.linkedin.com/in/dymenko/?originalSubdomain=ua
'''
...
# print "The overall comparison # is ", result
    ...
    # Test the quick_sort
    #shuffle(x)
    print ("The original data set is ", a)
    print ("The sorted array is ", quick_sort(a))
...
def main ():
    ...
    sent_file = open("ComparisonsData.txt")
